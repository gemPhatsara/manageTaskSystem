...
?>
    <div class="container-login100">
        <div class="wrap-login100 p-l-65 p-r-60 p-t-55 p-b-55" style="width:85%;height: 70em;overflow-y: scroll;">
            <form action="receiveProduct.php" method="post">
                    <span class="login100-form-title p-b-32">
                        ...
                        <div class="row col-md-12">
                            ...
                            <div class="col-md-1">   
                                <div >
                                    <button type="button" id="addProduct" class="btn btn-success btn-add">Add</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="list-product">
                            <div class="row col-md-12 product-rows data-rows" data-rows=1>
                                ...
                                <div class="col-md-5">
                                        ...
                                        <div class="wrap-input100 validate-input m-b-12" data-validate = "Username is required">
                                        <input class="input100" type="text" name="productDescription[]" >
                                            <span class="focus-input100"></span>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-5">     
                                        ...
                                        <div class="wrap-input100 validate-input m-b-12" data-validate = "Password is required">
                                            <input class="input100 unit-price number" type="number" min=0 name="unit-price[]" data-rows=1>
                                            <span class="focus-input100"></span>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#addProduct').click(function(){
            rows++;
            $.get("AddOrder.html", function (data) {
